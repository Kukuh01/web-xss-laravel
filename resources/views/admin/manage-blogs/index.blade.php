        ...
        <div class="max-w-7xl flex mx-auto sm:px-6 lg:px-8">
            @foreach($blogs as $blog)
                <div class="max-w-sm flex flex-col justify-between p-6 mx-1 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <a href="{{ route('manage-blogs.show', $blog) }}" class="text-center inline-flex w-1/2 items-center px-3 py-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        Read more
